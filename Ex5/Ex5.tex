...
\par\end{centering}
\caption{Espectrograma de \emph{Bohemian Rhapsody }solo Voz}
...
\par\end{centering}
\caption{Espectrograma de \emph{Bohemian Rhapsody }solo Piano}
\end{figure}
...
\par\end{centering}
\caption{Espectrograma de \emph{Bohemian Rhapsody }solo Guitarra}
\end{figure}
...
\par\end{centering}
\caption{Espectrograma de \emph{Bohemian Rhapsody }solo Bajos}
\end{figure}
...
\par\end{centering}
\caption{Espectrograma de \emph{Bohemian Rhapsody }solo Batería}
\end{figure}
