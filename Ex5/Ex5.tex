...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources/FiltroGraves}FALTA POTEAR FASE
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources/FiltroMedios}FALTA POTEAR FASE
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources/FiltroAgudos}FALTA POTEAR FASE
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources/InterconexionEnCascadaSimulaciónSinCorregir}FALTA
PLOTEAR FASE Y CAMBIAR COLORES
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources/InterconexionEnCascadaSimulación}FALTA
PLOTEAR FASE
\par\end{centering}
