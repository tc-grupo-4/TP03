...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources/InterconexionEnParaleloSimulaciónMínima}
\par\end{centering}
\caption{Simulación de interconexion en paralelo para caso de mínima ganancia}
\label{5_23}
\end{figure}

Como se puede ver en las figuras \ref{5_22} y \ref{5_23}, el ancho
de los filtros para la máxima atenuación produce una superposicion
de filtros no deseada, en cambio en el caso de la máxima ganancia,
el ancho de los filtros permanecen demasiado pequeños, por lo que
el control sobre la banda de frecuencias intermedias no será el deseado.
Sumado a esto, se debe tener en cuenta que utilizar un diagrama en
cascada agrega un amplificado operacional extra para poder realizar
la suma de las 3 señales, por lo cual, esto significará un costo adicional
a la implementación del ecualizador de tonos.
...
resultados que se observan en las figuras \ref{5_25} y \ref{5_26}.
\begin{figure}[H]
\begin{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources/InterconexionEnCascadaSimulaciónMinima}
\par\end{centering}
\caption{Simulación de interconexion en cascada para caso de mínima ganancia}
\label{5_26}
\end{figure}
...
Por lo tanto, simulando ahora el nuevo ecualizadror, se puede ver
en las figuras \ref{5_27} y \ref{5_28}, que la ganancia no supera
un valor maximo razonable, por lo tanto, no dañará a nuestros equipos.

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{\string"Resources/Simulación ecualizador Máxima Ganancia\string".png}
\par\end{centering}
\caption{Simulación del ecualizador para la máxima ganancia}
\label{5_27}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{\string"Resources/Simulación ecualizador Mínima Ganancia\string".png}
\par\end{centering}
\caption{Simulación del ecualizador para la mínima ganancia}
\label{5_28}
...
\par\end{centering}
\caption{Máxima y mínima ganancia del ecualizador}
\label{5_29}
