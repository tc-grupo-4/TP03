...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.5]{Resources/DiagramaParametrico}tomando
R1=330 ohms
\par\end{centering}
...
\begin{figure}[h]
\begin{centering}
\includegraphics{Resources/RtaEnFrecuanciaParametrica}tomando R1=330
OHMS
\par\end{centering}
\caption{Respuesta en frecuencia paramétrica}
