...
\begin{center}
	\begin{figure}[H]	
	\makebox[\textwidth]{\includegraphics[scale=0.5,keepaspectratio]{../Ex3/ModoCOMunMONTECARLO-MAGNITUD.pdf}}
	\caption{Simulación de montecarlo del modo común en magnitud}
	\label{fig:montecarlocomunmagnitud}
	\end{figure}
\end{center}
...
\begin{center}
	\begin{figure}[H]	
	\makebox[\textwidth]{\includegraphics[scale=0.5,keepaspectratio]{../Ex3/ModoCOMunMONTECARLO-FASE.pdf}}
	\caption{Simulación de montecarlo del modo común en fase}
	\label{fig:montecarlocomunfase}
	\end{figure}
\end{center}

\begin{center}
	\begin{figure}[H]	
	\makebox[\textwidth]{\includegraphics[scale=0.5,keepaspectratio]{../Ex3/ModoDIFerencialMONTECARLO.pdf}}
